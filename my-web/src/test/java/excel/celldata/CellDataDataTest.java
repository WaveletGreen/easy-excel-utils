...
public class CellDataDataTest {
    ...
    private List<CellDataData> data() throws Exception {
        ...
        CellData formulaValuex = new CellData();
        formulaValuex.setFormula(Boolean.TRUE);
        formulaValuex.setFormulaValue("VLOOKUP(B2,C2:D2,1,0)");
        cellDataData.setData(formulaValuex);
